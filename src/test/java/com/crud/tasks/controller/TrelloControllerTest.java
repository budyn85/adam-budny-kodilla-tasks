...
@RunWith(SpringRunner.class)    //uruchamia kontekst springa
@WebMvcTest(TrelloController.class)   //uruchamia automat. konfig. struktury MVC oraz udost. jeden controller do testow
public class TrelloControllerTest {

    @Autowired
    private MockMvc mockMvc;     //klasa wyk. wysylanie zadan http
